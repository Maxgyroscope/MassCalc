...
%for i=1:5
BKD_Param_Stuct(1) = struct('Val',zeros(1,1),...
                         'NoData',zeros(1,1),...
                         'LineCut',zeros(1,1),...
                         'OutOfRange',zeros(1,1),...
                         'TempArr',LH_TS_TEMP);
BKD_Param_Stuct(2) = struct('Val',zeros(1,1),...
                         'NoData',zeros(1,1),...
                         'LineCut',zeros(1,1),...
                         'OutOfRange',zeros(1,1),...
                         'TempArr',RH_TS_TEMP);
BKD_Param_Stuct(3) = struct('Val',zeros(1,1),...
                         'NoData',zeros(1,1),...
                         'LineCut',zeros(1,1),...
                         'OutOfRange',zeros(1,1),...
                         'TempArr',CT_TS_TEMP);
BKD_Param_Stuct(4) = struct('Val',zeros(1,1),...
                         'NoData',zeros(1,1),...
                         'LineCut',zeros(1,1),...
                         'OutOfRange',zeros(1,1),...
                         'TempArr',LH_FCS_TS_TEMP);
BKD_Param_Stuct(5) = struct('Val',zeros(1,1),...
                         'NoData',zeros(1,1),...
                         'LineCut',zeros(1,1),...
                         'OutOfRange',zeros(1,1),...
                         'TempArr',RH_FCS_TS_TEMP);
%end
